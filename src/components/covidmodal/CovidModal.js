...
export default class MenuHeader extends Component {
    ...
    render() {
        return (
            <Modal dimmer="blurring" trigger={<Button onClick={() => this.trackGA("COVID-19")} color="yellow"><Icon name='stethoscope' />COVID-19 Updates</Button>} closeIcon>
                ...
                <Modal.Content image>
                    ...
                    <Modal.Description>
                        ...
                        <p>Our team at Campus Lightbox understands that this a tough time, 
                            ...
                            this trying time. Unprecedented times, call for unprecedented 
                            care! Stay safe.</p>
                            <a href="https://students.ubc.ca/covid19" target="_blank" rel="noopener noreferrer">
                            <Button color='blue'>UBC Resources for COVID-19</Button></a>
